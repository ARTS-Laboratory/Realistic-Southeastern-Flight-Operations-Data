...
# Load the image
image_path =  r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Greenville to Augusta\Profile10\Picture10_fuel.png" # Change this to your image file
...
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Greenville to Augusta\Profile10\fuel_flow\extracted_points.csv", data_points, delimiter=",", header="x_pixel,y_pixel", comments="")
...
transition_duration2 = 0.5 # Transition lasts 60s (1 minute)
...
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Greenville to Augusta\Profile10\fuel_flow\interp_extracted_points_power1_shaft.csv", power_shaft_vs_time_fuel, delimiter=",", header="Time_mins,power_kw", comments="")

#Save Power versus time as csv file
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Greenville to Augusta\Profile10\fuel_flow\interp_extracted_points_power_fuel.csv", power_vs_time_fuel, delimiter=",", header="Time_mins,Power_kW", comments="")

#Save Fuel flow vs. time file
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Greenville to Augusta\Profile10\fuel_flow\extracted_points_fuel_flow.csv", time_vs_fuel_flow, delimiter=",", header="Time_mins,fuel flow (Gal/hr)", comments="")

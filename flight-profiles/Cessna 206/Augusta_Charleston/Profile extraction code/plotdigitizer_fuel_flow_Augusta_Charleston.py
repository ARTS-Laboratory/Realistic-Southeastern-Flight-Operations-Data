...
# Load the image
image_path =  r"C:\Users\oadebajo\OneDrive\Documents\Research\USC research\Flight load profiles\Augusta to Charleston\Profile1\Picture1.png"# Change this to your image file
...
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Research\USC research\Flight load profiles\Augusta to Charleston\Profile1\extracted_points.csv", data_points, delimiter=",", header="x_pixel,y_pixel", comments="")
...
# takeoff_start2 = float(input("Enter time of takeoff2 start: "))
# takeoff_stop2 = float(input("Enter takeoff2 stop time: "))
transition_duration = 0.2  # Transition lasts 60s (1 minute)
transition_duration2 = 0.4
 # Transition lasts 60s (1 minute)
...
efficiency_points_time = [
    ...
    # takeoff_start2,
    # takeoff_start2+ transition_duration,
    # takeoff_stop2 - transition_duration2,
    # takeoff_stop2,
...
efficiency_points_values = [
    ...
    0.20,  # After first 1-minute transition (takeoff)
    0.20,  #0.19 # Before last 1-minute transition (takeoff)
    0.30,
    # 0.30,
    # 0.25,
    # 0.25,
...
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Research\USC research\Flight load profiles\Augusta to Charleston\Profile1\interp_extracted_points_power1_shaft.csv", power_shaft_vs_time_fuel, delimiter=",", header="Time_mins,power_kw", comments="")

#Save Power versus time as csv file
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Research\USC research\Flight load profiles\Augusta to Charleston\Profile1\interp_extracted_points_power_fuel.csv", power_vs_time_fuel, delimiter=",", header="Time_mins,Power_kW", comments="")

#Save Fuel flow vs. time file
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Research\USC research\Flight load profiles\Augusta to Charleston\Profile1\extracted_points_fuel_flow.csv", time_vs_fuel_flow, delimiter=",", header="Time_mins,fuel flow (Gal/hr)", comments="")

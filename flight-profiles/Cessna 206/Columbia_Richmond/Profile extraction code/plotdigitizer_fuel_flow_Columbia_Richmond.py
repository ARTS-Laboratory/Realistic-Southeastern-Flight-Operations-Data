...
# Load the image
image_path =  r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Columbia to Richmond\Profile10\Picture10_fuel.png" # Change this to your image file
...
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Columbia to Richmond\Profile10\fuel_flow\extracted_points.csv", data_points, delimiter=",", header="x_pixel,y_pixel", comments="")
...
takeoff2_start = float(input("Enter time of takeoff2 start: "))
takeoff2_stop = float(input("Enter takeoff2 stop time:"))
transition_duration = 0.3  # Transition lasts 60s (1 minute)
...
efficiency_points_time = [
    ...
    takeoff_stop - transition_duration,  # Start of last transition
    takeoff_stop,                     # End of takeoff
    takeoff2_start,                   # Start of takeoff
    takeoff2_start + 0.1,  # End of first transition
    takeoff2_stop - 0.3,  # Start of last transition
    takeoff2_stop, 
...
efficiency_points_values = [
    ...
    0.29,  # After takeoff stop (cruise)
    0.29,
    0.23,
    0.23,
    0.30,
...
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Columbia to Richmond\Profile10\fuel_flow\interp_extracted_points_power1_shaft.csv", power_shaft_vs_time_fuel, delimiter=",", header="Time_mins,power_kw", comments="")

#Save Power versus time as csv file
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Columbia to Richmond\Profile10\fuel_flow\interp_extracted_points_power_fuel.csv", power_vs_time_fuel, delimiter=",", header="Time_mins,Power_kW", comments="")

#Save Fuel flow vs. time file
np.savetxt(r"C:\Users\oadebajo\OneDrive\Documents\Flight load profiles\Columbia to Richmond\Profile10\fuel_flow\extracted_points_fuel_flow.csv", time_vs_fuel_flow, delimiter=",", header="Time_mins,fuel flow (Gal/hr)", comments="")
